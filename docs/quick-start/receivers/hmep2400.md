...
??? Note "Flashing via FTDI"
    ...
    4. Once the process is done, unsolder the receiver from the FTDI Adapter, unbridge the boot pads and rewire it into your FC as per the [Wiring Guide].
