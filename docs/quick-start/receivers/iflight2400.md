...
!!! Warning "Important Step!"
    ...
    <figure markdown>
    ![iFlight 2.4GHz Receiver Identification](../../assets/images/iflight-2400ident.png)
	<figcaption>How to identify the correct iFlight 2.4GHz receiver target</figcaption>
    </figure>
