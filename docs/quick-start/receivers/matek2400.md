...
Following are the flashing methods for Matek R24.
...
??? Note "Flashing via WiFi"
    ...
    ??? Note "Method 1 (Recommended as first-flash method)"
        ...
        3. Build the firmware, which will open the Target folder where the `MATEK_2400_RX-<version>.bin` or `MATEK_2400_RX_R24D-<version>.bin` file is located. Do not close this window so you can easily locate the correct file to upload to the module.
        ...
        7. Drag and drop the firmware file, `MATEK_2400_RX-<version>.bin` or `MATEK_2400_RX_R24D-<version>.bin`, created by the ExpressLRS Configurator. Alternatively, use the `Choose File` button to select the file from the folder where the firmware was created.
    ...
    ??? Note "Method 2"
        ...
        8. Drag and drop the firmware file, `MATEK_2400_RX-<version>.bin` or `MATEK_2400_RX_R24D-<version>.bin`, created by the ExpressLRS Configurator. Alternatively, use the `Choose File` button to select the file from the folder where the firmware was created.
