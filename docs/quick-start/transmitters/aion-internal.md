...
!!! danger "Advisory"
    Not all Jumper T Pro's come with an internal ELRS receiver. Some come with a "multi JP4in1 multi-protocol module". This tutorial does not apply to those Jumper T Pro's. Check the page you bought it from carefully to determine which unit you purchased.
