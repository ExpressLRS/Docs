...
=== "via UART"
    ...
    2. Determine whether your TX Module is being detected properly as a USB-to-UART Device.
        ...
        - You can download the drivers from here: [CP210x Drivers](https://www.silabs.com/developers/usb-to-uart-bridge-vcp-drivers?tab=downloads) or [CH9102](https://sparks.gogo.co.nz/ch340.html)
