...
=== "ExpressLRS 4.0+ Web UI"
    ...
    This tab allows users to change the serial protocol and baudrate of a UART-based receiver, or a PWM receiver configured with pins set for serial output. See [Serial Protocols](../software/serial-protocols.md) for more information.
